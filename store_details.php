...
<?php $sellerProduct = viewSellerProduct($seller); ?>
<?php $latest_product = viewLatestProducts($seller); ?>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="./stores.php">Store</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shoping-cart.php">Shoping Cart</a></li>
                                    <li><a href="./checkout.php">Check Out</a></li>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <?php foreach($sellerProduct as $product) { ?>
                            <li><a href="store_details.php?id=<?= $product['id']; ?>"><?= $product['product_name']; ?></a></li>
                        <?php } ?>
                        ...
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <?php foreach(array_chunk($latest_product, 3) as $chunk) { ?>
                                        <div class="latest-prdouct__slider__item">
                                            <?php foreach($chunk as $product) { ?>
                                                <a href="#" class="latest-product__item">
                                                    <div class="latest-product__item__pic">
                                                        <img src="/e-commerce/uploads/<?= $product['product_image'] ?>" alt="">
                                                    </div>
                                                    <div class="latest-product__item__text">
                                                        <h6><?= $product['vendor_name'] ?></h6>
