            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/list/seller_accounts.php">Seller Accounts</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/list/customer_accounts.php">Customer Accounts</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/list/products.php">Products</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <div class="row" id="proBanner">
                <div class="col-12">
                    <span class="d-flex align-items-center purchase-popup">
                        <p>Welcome, <?= $adminDetails['fullname'] ?>! Explore your sales and manage your products.</p>
