...
<?php $customerData = viewCustomerDetails($_GET['id']); ?>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    ?>
                    <h4 class="card-title">Manage customer Account</h4>
                    <?php banCustomerAccount(); ?>
                    <?php deleteSellerAccount(); ?>
                    <?php customerSettings(); ?>
                    <p class="card-description"> Lorem ipsum </p>

                    <img src="/e-commerce/img/business_account/<?= isset($customerData['image']) ? $customerData['image'] : '' ?>" alt="Store image" height="200px" class="mb-3">
                    <form action="" method="post" enctype="multipart/form-data" class="forms-sample">

                        <div class="form-group">
                            <label for="fname">First Name</label>
                            <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter First Name" value="<?= isset($customerData['firstname']) ? $customerData['firstname'] : '' ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="lname">Last Name</label>
                            <input type="text" class="form-control" id="lname" name="lname" placeholder="Enter Last Name" value="<?= isset($customerData['lastname']) ? $customerData['lastname'] : '' ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="mname">Middle Name</label>
                            <input type="text" class="form-control" id="mname" name="mname" placeholder="Enter Middle Name" value="<?= isset($customerData['middlename']) ? $customerData['middlename'] : '' ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email" value="<?= isset($customerData['email']) ? $customerData['email'] : '' ?>" required>
                        </div>
