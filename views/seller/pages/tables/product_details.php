                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="container mt-3">
                                        <a href="/e-commerce/views/seller/pages/products/product_list.php" class="btn btn-outline-primary mr-2">View Products</a>
                                        <a href="/e-commerce/views/seller/pages/forms/add_new_stock.php?id=<?= $product['productDetails']['id']; ?>" class="btn btn-outline-success">Add New Stocks</a>
                                    </div>
                                </div>
                            </div>
                        </div>
