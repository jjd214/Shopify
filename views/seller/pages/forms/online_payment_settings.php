...
<?php $paymentDetails = viewOnlinePaymentDetails($sellerDetails['id']); ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Online Payment Settings </h3>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php onlinePaymentSettings(); ?>
                    <p class="card-description"> Lorem ipsum </p>
                    <img src="/e-commerce/img/qr_code/<?= isset($paymentDetails['qr_code']) ? $paymentDetails['qr_code'] : '' ?>" alt="QR CODE" height="200px" class="mb-3">
                    <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                    <div class="form-group">
                            <label for="product_image">Upload Gcash QR Code</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="qr_code" aria-describedby="file-upload-info">
                                    <label class="custom-file-label" style="padding-top: 10px;">Choose file</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="store_name">Full Name</label>
                            <input type="text" class="form-control" id="gcash_name" name="gcash_name" placeholder="Enter GCash Name" value="<?= isset($paymentDetails['fullname']) ? $paymentDetails['fullname'] : '' ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="email">Gcash Number</label>
                            <input type="number" class="form-control" id="number" name="number" placeholder="Enter GCash Number" value="<?= isset($paymentDetails['gcash_number']) ? $paymentDetails['gcash_number'] : '' ?>" required>
                        </div>
